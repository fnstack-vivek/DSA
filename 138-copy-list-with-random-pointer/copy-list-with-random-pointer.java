class Solution {
   ...
   public void  rendomconnection(Node head1,Node head2){
    Node temp1=head1;
    Node temp2=head2;
    while(temp1!=null&&temp2!=null){
        if(temp1.random==null) temp2.random=null;
        else temp2.random=temp1.random.next;//main
   ...
   public Node copyRandomList(Node head1) {
    ...
    //step2: Alternatively connecting list
    merge(head1,head2);
    //step3:Assigning random pointer
    rendomconnection(head1,head2);
    //step4: seprate out llist
    split(head1);
    return head2;
